...
describe("Hand", function() {
	...
	it("can check for one pair", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([0,3,4,5,6]);
	});
	...
	it("can check for full house", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([0,1,2,3,5]);
	});
	...
	it("can check for three of a kind", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([1,2,3,4,5]);
	});
	...
	it("can check for four of a kind", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([0,1,2,4,5]);
	});
	...
	it("can check for a straight", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([1,2,4,5,6]);
	});
	...
	it("can check for straight flush", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([1,2,3,4,6]);
	});
	...
	it("can check for high card", function() {
		...
		expect(hand.getUsedCardIndices()).toEqual([2,3,4,5,6]);
	});
