(() => {
  ...
  var require_howler = __commonJS((exports) => {
    /*!
     *  howler.js v2.2.3
     *  howlerjs.com
     *
    ...
    (function() {
      ...
      HowlerGlobal2.prototype = {
          ...
          if (typeof vol !== "undefined" && vol >= 0 && vol <= 1) {
            ...
            for (var i4 = 0; i4 < self._howls.length; i4++) {
              if (!self._howls[i4]._webAudio) {
                var ids = self._howls[i4]._getSoundIds();
                for (var j4 = 0; j4 < ids.length; j4++) {
                  var sound = self._howls[i4]._soundById(ids[j4]);
        ...
        _autoSuspend: function() {
          ...
          for (var i4 = 0; i4 < self._howls.length; i4++) {
            if (self._howls[i4]._webAudio) {
              for (var j4 = 0; j4 < self._howls[i4]._sounds.length; j4++) {
                if (!self._howls[i4]._sounds[j4]._paused) {
                  return self;
                }
              }
            }
      ...
      var Howl3 = function(o4) {
        var self = this;
        if (!o4.src || o4.src.length === 0) {
      ...
      Howl3.prototype = {
        init: function(o4) {
          ...
          self._autoplay = o4.autoplay || false;
          self._format = typeof o4.format !== "string" ? o4.format : [o4.format];
          self._html5 = o4.html5 || false;
          self._muted = o4.mute || false;
          self._loop = o4.loop || false;
          self._pool = o4.pool || 5;
          self._preload = typeof o4.preload === "boolean" || o4.preload === "metadata" ? o4.preload : true;
          self._rate = o4.rate || 1;
          self._sprite = o4.sprite || {};
          self._src = typeof o4.src !== "string" ? o4.src : [o4.src];
          self._volume = o4.volume !== void 0 ? o4.volume : 1;
          self._xhr = {
            method: o4.xhr && o4.xhr.method ? o4.xhr.method : "GET",
            headers: o4.xhr && o4.xhr.headers ? o4.xhr.headers : null,
            withCredentials: o4.xhr && o4.xhr.withCredentials ? o4.xhr.withCredentials : false
          };
          self._duration = 0;
          ...
          self._onend = o4.onend ? [{fn: o4.onend}] : [];
          self._onfade = o4.onfade ? [{fn: o4.onfade}] : [];
          self._onload = o4.onload ? [{fn: o4.onload}] : [];
          self._onloaderror = o4.onloaderror ? [{fn: o4.onloaderror}] : [];
          self._onplayerror = o4.onplayerror ? [{fn: o4.onplayerror}] : [];
          self._onpause = o4.onpause ? [{fn: o4.onpause}] : [];
          self._onplay = o4.onplay ? [{fn: o4.onplay}] : [];
          self._onstop = o4.onstop ? [{fn: o4.onstop}] : [];
          self._onmute = o4.onmute ? [{fn: o4.onmute}] : [];
          self._onvolume = o4.onvolume ? [{fn: o4.onvolume}] : [];
          self._onrate = o4.onrate ? [{fn: o4.onrate}] : [];
          self._onseek = o4.onseek ? [{fn: o4.onseek}] : [];
          self._onunlock = o4.onunlock ? [{fn: o4.onunlock}] : [];
          self._onresume = [];
        ...
        play: function(sprite, internal) {
          ...
          var start2 = self._sprite[sprite][0] / 1e3;
        ...
        pause: function(id) {
          ...
          for (var i4 = 0; i4 < ids.length; i4++) {
            self._clearTimer(ids[i4]);
            var sound = self._soundById(ids[i4]);
            if (sound && !sound._paused) {
              sound._seek = self.seek(ids[i4]);
              sound._rateSeek = 0;
              sound._paused = true;
              self._stopFade(ids[i4]);
              if (sound._node) {
                if (self._webAudio) {
        ...
        volume: function() {
          ...
          if (typeof vol !== "undefined" && vol >= 0 && vol <= 1) {
            ...
            for (var i4 = 0; i4 < id.length; i4++) {
              sound = self._soundById(id[i4]);
              if (sound) {
                sound._volume = vol;
                if (!args[2]) {
                  self._stopFade(id[i4]);
                }
        ...
        fade: function(from, to, len, id) {
          ...
          for (var i4 = 0; i4 < ids.length; i4++) {
            ...
            if (sound) {
              ...
              self._startFadeInterval(sound, from, to, len, ids[i4], typeof id === "undefined");
            }
          }
          return self;
        },
            ...
            if (sound) {
              ...
              if (self._webAudio && sound._node && sound._node.bufferSource) {
                ...
                if (loop) {
                  ...
                  if (self.playing(ids[i4])) {
                    self.pause(ids[i4], true);
                    self.play(ids[i4], true);
                  }
                }
              }
            }
        ...
        rate: function() {
          ...
          if (typeof rate === "number") {
            ...
            for (var i4 = 0; i4 < id.length; i4++) {
              sound = self._soundById(id[i4]);
              if (sound) {
                if (self.playing(id[i4])) {
                  sound._rateSeek = self.seek(id[i4]);
                ...
                var seek = self.seek(id[i4]);
                var duration = (self._sprite[sound._sprite][0] + self._sprite[sound._sprite][1]) / 1e3 - seek;
                var timeout = duration * 1e3 / Math.abs(sound._rate);
                if (self._endTimers[id[i4]] || !sound._paused) {
                  self._clearTimer(id[i4]);
                  self._endTimers[id[i4]] = setTimeout(self._ended.bind(self, sound), timeout);
                }
        ...
        off: function(event, fn2, id) {
          ...
          if (fn2 || id) {
            for (i4 = 0; i4 < events.length; i4++) {
              var isId = id === events[i4].id;
              if (fn2 === events[i4].fn && isId || !fn2 && isId) {
                events.splice(i4, 1);
                break;
              }
            }
        ...
        _emit: function(event, id, msg) {
          ...
          for (var i4 = events.length - 1; i4 >= 0; i4--) {
            if (!events[i4].id || events[i4].id === id || event === "load") {
      ...
      var loadBuffer = function(self) {
        ...
        if (/^data:[^;]+;base64,/.test(url)) {
          ...
          for (var i4 = 0; i4 < data.length; ++i4) {
            dataView[i4] = data.charCodeAt(i4);
          }
    ...
    (function() {
      ...
      HowlerGlobal.prototype.pos = function(x4, y4, z3) {
        var self = this;
        if (!self.ctx || !self.ctx.listener) {
          return self;
        }
        y4 = typeof y4 !== "number" ? self._pos[1] : y4;
        z3 = typeof z3 !== "number" ? self._pos[2] : z3;
        if (typeof x4 === "number") {
          self._pos = [x4, y4, z3];
      ...
      HowlerGlobal.prototype.orientation = function(x4, y4, z3, xUp, yUp, zUp) {
        var self = this;
        if (!self.ctx || !self.ctx.listener) {
          return self;
        }
        ...
        if (typeof x4 === "number") {
          self._orientation = [x4, y4, z3, xUp, yUp, zUp];
          if (typeof self.ctx.listener.forwardX !== "undefined") {
            self.ctx.listener.forwardX.setTargetAtTime(x4, Howler.ctx.currentTime, 0.1);
            self.ctx.listener.forwardY.setTargetAtTime(y4, Howler.ctx.currentTime, 0.1);
            self.ctx.listener.forwardZ.setTargetAtTime(z3, Howler.ctx.currentTime, 0.1);
            self.ctx.listener.upX.setTargetAtTime(xUp, Howler.ctx.currentTime, 0.1);
            self.ctx.listener.upY.setTargetAtTime(yUp, Howler.ctx.currentTime, 0.1);
            self.ctx.listener.upZ.setTargetAtTime(zUp, Howler.ctx.currentTime, 0.1);
          } else {
            self.ctx.listener.setOrientation(x4, y4, z3, xUp, yUp, zUp);
          }
        } else {
          return or;
        }
      ...
      Howl.prototype.init = function(_super) {
        return function(o4) {
          var self = this;
          self._orientation = o4.orientation || [1, 0, 0];
          self._stereo = o4.stereo || null;
          self._pos = o4.pos || null;
          self._pannerAttr = {
            coneInnerAngle: typeof o4.coneInnerAngle !== "undefined" ? o4.coneInnerAngle : 360,
            coneOuterAngle: typeof o4.coneOuterAngle !== "undefined" ? o4.coneOuterAngle : 360,
            coneOuterGain: typeof o4.coneOuterGain !== "undefined" ? o4.coneOuterGain : 0,
            distanceModel: typeof o4.distanceModel !== "undefined" ? o4.distanceModel : "inverse",
            maxDistance: typeof o4.maxDistance !== "undefined" ? o4.maxDistance : 1e4,
            panningModel: typeof o4.panningModel !== "undefined" ? o4.panningModel : "HRTF",
            refDistance: typeof o4.refDistance !== "undefined" ? o4.refDistance : 1,
            rolloffFactor: typeof o4.rolloffFactor !== "undefined" ? o4.rolloffFactor : 1
          };
          self._onstereo = o4.onstereo ? [{fn: o4.onstereo}] : [];
          self._onpos = o4.onpos ? [{fn: o4.onpos}] : [];
          self._onorientation = o4.onorientation ? [{fn: o4.onorientation}] : [];
          return _super.call(this, o4);
        };
      }(Howl.prototype.init);
      ...
      Howl.prototype.pos = function(x4, y4, z3, id) {
        var self = this;
        if (!self._webAudio) {
          return self;
        }
          ...
          if (sound) {
            if (typeof x4 === "number") {
              ...
              if (sound._node) {
                ...
                if (typeof sound._panner.positionX !== "undefined") {
                  sound._panner.positionX.setValueAtTime(x4, Howler.ctx.currentTime);
                  ...
                  sound._panner.setPosition(x4, y4, z3);
                }
              }
      ...
      Howl.prototype.orientation = function(x4, y4, z3, id) {
        var self = this;
        if (!self._webAudio) {
          return self;
        }
        if (self._state !== "loaded") {
          self._queue.push({
            event: "orientation",
            action: function() {
              self.orientation(x4, y4, z3, id);
            }
          });
          return self;
        }
        y4 = typeof y4 !== "number" ? self._orientation[1] : y4;
        z3 = typeof z3 !== "number" ? self._orientation[2] : z3;
        if (typeof id === "undefined") {
          if (typeof x4 === "number") {
            self._orientation = [x4, y4, z3];
          } else {
            ...
            if (typeof x4 === "number") {
              ...
              if (sound._node) {
                ...
                if (typeof sound._panner.orientationX !== "undefined") {
                  sound._panner.orientationX.setValueAtTime(x4, Howler.ctx.currentTime);
                  ...
                  sound._panner.setOrientation(x4, y4, z3);
                }
              }
      ...
      Howl.prototype.pannerAttr = function() {
        ...
        if (args.length === 0) {
          ...
          if (typeof args[0] === "object") {
            ...
            if (typeof id === "undefined") {
              if (!o4.pannerAttr) {
                o4.pannerAttr = {
                  coneInnerAngle: o4.coneInnerAngle,
                  coneOuterAngle: o4.coneOuterAngle,
                  coneOuterGain: o4.coneOuterGain,
                  distanceModel: o4.distanceModel,
                  maxDistance: o4.maxDistance,
                  refDistance: o4.refDistance,
                  rolloffFactor: o4.rolloffFactor,
                  panningModel: o4.panningModel
                };
              }
              self._pannerAttr = {
                coneInnerAngle: typeof o4.pannerAttr.coneInnerAngle !== "undefined" ? o4.pannerAttr.coneInnerAngle : self._coneInnerAngle,
                coneOuterAngle: typeof o4.pannerAttr.coneOuterAngle !== "undefined" ? o4.pannerAttr.coneOuterAngle : self._coneOuterAngle,
                coneOuterGain: typeof o4.pannerAttr.coneOuterGain !== "undefined" ? o4.pannerAttr.coneOuterGain : self._coneOuterGain,
                distanceModel: typeof o4.pannerAttr.distanceModel !== "undefined" ? o4.pannerAttr.distanceModel : self._distanceModel,
                maxDistance: typeof o4.pannerAttr.maxDistance !== "undefined" ? o4.pannerAttr.maxDistance : self._maxDistance,
                refDistance: typeof o4.pannerAttr.refDistance !== "undefined" ? o4.pannerAttr.refDistance : self._refDistance,
                rolloffFactor: typeof o4.pannerAttr.rolloffFactor !== "undefined" ? o4.pannerAttr.rolloffFactor : self._rolloffFactor,
                panningModel: typeof o4.pannerAttr.panningModel !== "undefined" ? o4.pannerAttr.panningModel : self._panningModel
              };
            }
          } else {
            sound = self._soundById(parseInt(args[0], 10));
        ...
        for (var i4 = 0; i4 < ids.length; i4++) {
          ...
          if (sound) {
            ...
            pa = {
              coneInnerAngle: typeof o4.coneInnerAngle !== "undefined" ? o4.coneInnerAngle : pa.coneInnerAngle,
              coneOuterAngle: typeof o4.coneOuterAngle !== "undefined" ? o4.coneOuterAngle : pa.coneOuterAngle,
              coneOuterGain: typeof o4.coneOuterGain !== "undefined" ? o4.coneOuterGain : pa.coneOuterGain,
              distanceModel: typeof o4.distanceModel !== "undefined" ? o4.distanceModel : pa.distanceModel,
              maxDistance: typeof o4.maxDistance !== "undefined" ? o4.maxDistance : pa.maxDistance,
              refDistance: typeof o4.refDistance !== "undefined" ? o4.refDistance : pa.refDistance,
              rolloffFactor: typeof o4.rolloffFactor !== "undefined" ? o4.rolloffFactor : pa.rolloffFactor,
              panningModel: typeof o4.panningModel !== "undefined" ? o4.panningModel : pa.panningModel
            };
...
` + f2(this.__v)), h2.call(this, n2);
  ...
  var NumberUtil = class {
    static safeParseInt(s4) {
      return parseInt(s4) || 0;
    }
  ...
  var NumberUtil_default = NumberUtil;

  // src/client/view/StatusView.jsx
  var StatusView_default = (props) => {
    let now2 = usePerformanceNow();
    let elapsed = now2 - props.state.stateTime;
    let timeLeft = props.state.statusTimeLeft - elapsed;
    let timeLeftFormatted = NumberUtil_default.formatMillis(timeLeft);
    let t3 = props.state.statusText.replace("%t", timeLeftFormatted);
    return /* @__PURE__ */ v("div", {
      class: "table-status"
    }, ReactUtil_default.linesToParagraphs(t3));
  };
  ...
  function TonopahView(props) {
    ...
    return /* @__PURE__ */ v(extendedAnimated.div, {
      ...
      class: "table-info"
    }, props.state.infoText)), ReactUtil_default.If(props.state.statusText, () => /* @__PURE__ */ v(StatusView_default, {
      state: props.state
    })), ReactUtil_default.If(props.state.buttons && props.state.buttons.length, () => /* @__PURE__ */ v(ButtonsView_default, {
      state: props.state,
      settings: props.settings,
      onButtonClick
  ...
  function TournamentInfoView(props) {
    ...
    if (props.state.tournamentStartsIn) {
      ...
      timeLeftFormatted = NumberUtil_default.formatMillis(timeLeft);
    }
    let texts = [];
  ...
  for (let el of document.getElementsByClassName("tonopah-client"))
    M(/* @__PURE__ */ v(TonopahClient, __assign({}, el.dataset)), el);
})();
